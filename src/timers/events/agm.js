 ...
 *
 * Chest spawns every 3 hours at 01:00, 04:00, 07:00, … 22:00 Pacific — one
 ...
 * window. Computed purely from the wall-clock time-of-day in realm time, so it
 * inherits the same DST behavior as the Python source.
 */
...
export function getState(now) {
  ...
  const msIntoDay = (realm.hour * 3600 + realm.minute * 60 + realm.second) * 1000;
